...
namespace AdvancedCompany.Unity.Moons
{
    internal class EnemyItem : MonoBehaviour
    {
        ...
        public void SetValue(LobbyConfiguration.MoonConfig.EnemyTableItem enemyConfig)
        {
            Config = enemyConfig;
            UpdateValues();
        }
